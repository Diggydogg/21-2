...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into spring_board (date, weather, temp, sensTemp, humidity, wind, desc) values (?,?,?,?,?,?,?)";
	private final String BOARD_UPDATE = "update spring_board set date=?, weather=?, temp=?,sensTemp=?, humidity=?, wind=?, desc=? where seq=?";
	...
	public int insertBoard(BoardVO vo) {
		return template.update(BOARD_INSERT, new Object[]{vo.getDate(), vo.getWeather(), vo.getTemp(), vo.getSensTemp(), vo.getHumidity(), vo.getWind(), vo.getDesc()});
	}
	...
	public int updateBoard(BoardVO vo) {
		return template.update(BOARD_UPDATE, new Object[]{vo.getDate(), vo.getWeather(), vo.getTemp(), vo.getSensTemp(), vo.getHumidity(), vo.getWind(), vo.getDesc()});
	}
